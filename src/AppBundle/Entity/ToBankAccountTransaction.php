...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ToBankAccountTransactionRepository")
 * @ORM\Entity
 * @ORM\Table(name="to_bank_account_transaction")
 */
class ToBankAccountTransaction
{
    /**
     * @ORM\Column(
     *     name="to_bank_account_transaction_id",
     *     type="integer"
     * )
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $to_bank_account_transaction_id;
    ...
    /**
     * @ManyToOne(targetEntity="FinanceAccountUser", inversedBy="to_bank_account_transaction")
    ...
    /**
     * Get toBankAccountTransactionId
     *
     * @return integer
     */
    public function getToBankAccountTransactionId()
    {
        return $this->to_bank_account_transaction_id;
    }
